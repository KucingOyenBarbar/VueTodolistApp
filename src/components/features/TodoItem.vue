  ...
  <div class="card">
    <div class="card-body">
      <div class="d-flex justify-content-end g-2 mb-3">
        <span v-if="todo.completed" class="badge rounded-pill text-bg-warning"
          >Ditandai Selesai</span
        >
        <span v-else class="badge rounded-pill text-bg-success"> Aktif</span>
      </div>
...
export default {
  name: "TodoItem",
  props: ["todo", "deleteTodo", "completedTodo", "unCompletedTodo"],
  setup(props) {
    const { deleteTodo, completedTodo, unCompletedTodo } = props;
